...
public class ShowStudentLeaveDetails extends JFrame implements ActionListener{
    
    JButton Search,Refresh,Exit,Print, Update;
    JTextField rollNo;
    JTable table;
    ShowStudentLeaveDetails(){
        setSize(900,600);
        setLocation(50,50);
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae){
         if(ae.getSource()==Search){
             ...
             try {
                Conn cb = new Conn();
                ResultSet rs2 = cb.s.executeQuery("SELECT * FROM student_leave WHERE roll='"+strRollNo+"'");
